...
if __name__ == '__main__':
    ...
    # args.image_dir = 'sample_images/grill/Tteokgalbi'
    # 정답을 폴더와 일치하게 정해놓기 => confusion matrix 그리기 위
    args.image_dir = 'keeponeimage'
    ...
    while (num_images > 0): #사진한장이면 한번만 돈다.

        total_tic = time.time()
        if webcam_num == -1: # 비디오가 아니라면
            num_images -= 1
